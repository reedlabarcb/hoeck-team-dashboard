...
- Cron jobs (`railway.toml`): Box incremental daily 4 AM PT (12:00 UTC) `sync:box:incremental`; Box full Sun 5 AM PT (13:00 UTC) `sync:box:full`; **RealNex mirror daily 3 AM PT (11:00 UTC) `sync:realnex` — ENABLED 2026-07-07 (P3.4)**. Backup (`backup:weekly`) + PDF `extract-text` crons remain commented out.
